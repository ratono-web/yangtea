...
class Customers extends MY_Controller {
	...
	public function show_total_customer_return_amount($customer_id){
		return $this->db->select("coalesce(sum(paid_amount),0) as tot")->where("customer_id",$customer_id)->get("db_salesreturn")->row()->tot;
	}
	...
	public function ajax_list()
	{
		...
		foreach ($list as $customers) {
			...
			$row[] = app_number_format($this->show_total_customer_return_amount($customers->id));;
