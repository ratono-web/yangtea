            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><!--<?= $this->lang->line('total_paid'); ?>-->Total dibayar</th>
                  <!-- <th><?= $this->lang->line('total_paid'); ?>(-)</th>
                  <th><?= $this->lang->line('sales_due'); ?>(-)</th> -->
                  <th><!--<?= $this->lang->line('sales_return_due'); ?>(+)-->Total return</th>
...
<!-- pada halaman ini, telah di sesuaikan untuk menghilangkan dua kolom, yaitu sales due dan sales return due,
perubahan dilakukan pada: view -> table body, tfoot, script footer callback
                          controller -> customers/ajax_list  -->