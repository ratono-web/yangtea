                                        ...
                                        <div class="col-md-8 col-md-offset-2 d-flex justify-content" >
                                          <div class="input-group">
                                                <span class="input-group-addon" title="Select Items"><i class="fa fa-barcode"></i></span>
                                                 <input type="text" class="form-control " placeholder="Item name/Itemcode" id="item_search">
                                              </div>
                                        </div>
                                      </div>
                                      <div class="box-body">
                              ...
                              <div class="col-md-6">
                                <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <label for="discount_to_all_input" class="col-sm-4 control-label"><!--<?= $this->lang->line('discount_on_all'); ?>-->Potongan Pembelian</label>    
                                          <div class="col-sm-4">
                                    ...
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <table  class="col-md-9">
                                             ...
                                             <tr>
                                                <th class="text-right" style="font-size: 17px;"><!-- <?= $this->lang->line('discount_on_all'); ?> -->Potongam Pembelian</th>
                                                <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                                   <h4>
