        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p><!--<?= $this->lang->line('total_invoices'); ?>-->Total Bukti Transaksi</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p><!--<?= $this->lang->line('total_invoices_amount'); ?>-->Jumlah Transaksi Total</p>
            </div>
            <div class="icon">
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                ...
                <i class="fa fa-plus"></i> <?= $this->lang->line('create_new'); ?>Tambah</a>
              </div>
              <?php } ?> -->
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <th><!-- <?= $this->lang->line('sales_date'); ?>-->Tanggal Retur Penjualan</th>
                  <th><!--<?= $this->lang->line('sales_code'); ?>-->Nomor Penjualan</th>
                  <th><!--<?= $this->lang->line('return_code'); ?>-->Nomor Retur Penjualan</th>
               ...
               <tfoot>
                  <tr class="bg-gray">
                      <th colspan="5" style="text-align:right">Total</th><!-- 6 -->
                      <!-- <th></th>7 -->
                      <!-- <th></th>7 -->
                      <!-- <th></th>7 -->
                      <th></th><!-- 7 -->
      ...
      buttons: {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
          ...
          //       }, 0 );
            ...
            $( api.column( 5 ).footer() ).html('Rp. '+app_number_format(totol));
