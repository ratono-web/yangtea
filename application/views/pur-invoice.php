      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> <!--<?= $this->lang->line('purchase_invoice'); ?>-->Bukti Pembelian
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped records_table table-bordered">
            ...
            <tfoot class="text-right text-bold bg-gray">
              <tr>
                <td colspan="5" class="text-center"><?= $this->lang->line('total'); ?></td>
           ...
           <div class="row">
              <div class="col-md-12">
                 <div class="form-group">
                    <label for="discount_to_all_input" class="col-sm-4 control-label" style="font-size: 17px;"><!--<?= $this->lang->line('discount_on_all'); ?>-->Potongan Pembelian</label>    
                    <div class="col-sm-8">
              ...
              <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <table  class="col-md-11">
                       ...
                       <tr>
                          <th class="text-right" style="font-size: 17px;"><!--<?= $this->lang->line('discount_on_all'); ?>-->Potongan Pembelian</th>
                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
