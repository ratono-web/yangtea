        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   ...
                   <span class="info-box-number"><?= $CI->currency(app_number_format($tot_sal_month_total)); ?></span>
                </div>
             </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Penjualan Keseluruhan</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Pembelian bulan ini</span>
                   <span class="info-box-number"><?= $CI->currency(app_number_format($tot_pur_month_total)); ?></span>
                </div>
             </div>
          </div>
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="info-box">
                ...
                <div class="info-box-content">
                   <span class="text-bold text-uppercase">Pembelian Keseluruhan</span>
                     <span class="info-box-number"><?= $CI->currency(app_number_format($tot_pur_grand_total)); ?></span>
                   </span>
                </div>
             </div>
          </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body table-responsive">
              <table id="" class="table table-bordered table-hover">
                ...
                <tbody>
        <?php
        $this->db->select('b.category_name,a.item_name,a.item_code,a.stock');
