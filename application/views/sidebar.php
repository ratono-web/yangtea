...
<header class="main-header">
  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('sales_add')  || $CI->permissions('pos')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view') || $CI->permissions('sales_return_add')) { ?>
        ...
        <li class="sales-return-list-active-li"><a href="<?php echo $base_url; ?>sales_return"><i class="fa fa-list "></i> <span><!--<?= $this->lang->line('sales_returns_list'); ?>-->Daftar Retur Penjualan</span></a></li>
        <?php } ?>
    ...
    <?php if($CI->permissions('purchase_add') || $CI->permissions('purchase_view') || $CI->permissions('purchase_return_view') || $CI->permissions('new_purchase_return')) { ?>
		<li class="purchase-list-active-li purchase-active-li purchase-returns-list-active-li purchase-returns-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="purchase-returns-active-li"><a href="<?php echo $base_url; ?>purchase_return/create"><i class="fa fa-plus-square-o "></i> <span><?= $this->lang->line('new_purchase_return'); ?>Retur Pembelian Baru</span></a></li>
            <?php } ?> -->
            <?php if($CI->permissions('purchase_return_view')) { ?>
            <li class="purchase-returns-list-active-li"><a href="<?php echo $base_url; ?>purchase_return"><i class="fa fa-list "></i> <span><!--<?= $this->lang->line('purchase_returns_list'); ?>-->Daftar Retur Pembelian</span></a></li>
            <?php } ?>
          </ul>
        </li>
        <?php } ?>
