                  ...
                  <div class="col-md-12">
                     ...
                     <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                           <li class="active"><a href="#tab_1" data-toggle="tab"><?= $this->lang->line('item'); ?></a></li>
                                       ...
                                       <input type="hidden" id="base_url" value="<?php echo $base_url;; ?>">
                                          ...
                                          <table class="table table-bordered table-hover " id="report-data" >
                                            ...
                                            <tr class="bg-blue">
                                              ...
                                              <th style=""><?= $this->lang->line('unit'); ?></th>
                                              <th style=""><?= $this->lang->line('purchase_price'); ?>(<?= $CI->currency(); ?>)</th>
                                              <!-- <th style="">Stok Awal</th> -->
                                              <th style="">Stok Akhir</th>
                                              <!-- <th style=""><?= $this->lang->line('current_stock'); ?></th> -->
                                              <!-- <th style=""><?= $this->lang->line('stock_value'); ?></th> -->
                                              <th style="">Nilai Stok</th>
                                            </tr>
                                            </thead>
                                            <tbody id="tbodyid">
...
<script type="text/javascript">
  function load_reports(){
   ...
   $(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
        ...
        $.post("get_stock_report",{from_date:from_date,to_date:to_date,item_id:$("#item_id").val()},function(result){
